...
public class ApiHelper {
    ...
    public static final boolean HAS_MEDIA_COLUMNS_WIDTH_AND_HEIGHT = hasField(MediaColumns.class,
            "WIDTH");
    ...
    public static final boolean HAS_RELEASE_SURFACE_TEXTURE = hasMethod("android.graphics.SurfaceTexture",
            "release");
    ...
    public static final boolean HAS_SET_SYSTEM_UI_VISIBILITY = hasMethod(View.class,
    ...
    public static final boolean HAS_GET_CAMERA_DISABLED = hasMethod(DevicePolicyManager.class,
            "getCameraDisabled", ComponentName.class);
    ...
    public static final boolean HAS_ROTATION_ANIMATION = hasField(WindowManager.LayoutParams.class,
            "rotationAnimation");
